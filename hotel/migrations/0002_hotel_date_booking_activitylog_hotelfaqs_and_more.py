# Generated by Django 5.2.1 on 2025-07-23 21:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_id', shortuuid.django_fields.ShortUUIDField(alphabet='abxchdjkiryteqolp', length=10, max_length=20, prefix='', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('icon_type', models.CharField(blank=True, choices=[('Bootstrap Icons', 'Bootstrap Icons'), ('Fontawsome Icons', 'Fontawsome Icons'), ('Box Icons', 'Box Icons'), ('Remi Icons', 'Remi Icons'), ('Flat Icons', 'Flat Icons')], max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hgid', shortuuid.django_fields.ShortUUIDField(alphabet='abxchdjkiryteqolp', length=10, max_length=20, prefix='', unique=True)),
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotel.hotel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rid', shortuuid.django_fields.ShortUUIDField(alphabet='abxchdjkiryteqolp', length=10, max_length=20, prefix='', unique=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotel.hotel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rtid', shortuuid.django_fields.ShortUUIDField(alphabet='abxchdjkiryteqolp', length=10, max_length=20, prefix='', unique=True)),
